...
<html lang="en-US" class="no-js h-full">
  <head>
    ...
    <meta name="csrf-token" content="MGA-NgU_Hi9_BTcoK2QUDi9eAQUUUjg0GQLqmoHkMkenz6LgLfiPCbSA">

    <title data-suffix=" · Fly">
      Error 404
     · Fly</title>
...
<link rel="preload" href="/phx/ui/fonts/fragment-mono-italic.woff2" as="font" type="font/woff2" crossorigin>
    ...
    <link phx-track-static rel="stylesheet" href="/phx/assets/app-1a7757211c8d7dd2af9425fe4bac10d5.css?vsn=d">
    ...
    <script defer phx-track-static type="text/javascript" src="/phx/assets/app-69486ae776fee518f48addd887a64362.js?vsn=d">
    </script>
    
  </head>

  <body class="relative w-full h-full bg-gray-900 antialiased text-white">
    <main class="h-full">
      <header class="absolute z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-24 font-semibold text-sm">
        <a href="/" class="relative z-50">
          
<svg aria-labelledby="title-GFfyJtLEXvRjpthCdescription-GFfyJtLEmlRjpthS" class="filter-shadow-purple" role="img" style="pointer-events: none; width: auto; height: 36px;" aria-hidden="true" viewBox="0 0 259 84" fill-rule="evenodd">
  <title id="title-GFfyJtLE-eBjpthi">
    
      
    
  </title>
  <desc id="description-GFfyJtLFGNBjpthy">
  ...
  <defs>
    <radialGradient id="ywv_Radial1" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(43.593 41.714) scale(59.4764)">
      ...
      <article class="bg-custom bg-fixed bg-center bg-cover relative flex flex-col items-center justify-center h-full" style="
          --bg: url(/phx/ui/images/cityscape-1b318f591f12bf31c9dc61465b689cbe.jpg?vsn=d);
          --bg-lg: url(/phx/ui/images/cityscape@2x-d120d4f08746a75b06eb4646b5964460.jpg?vsn=d);
        ">
        <div class="w-full max-w-xl px-6 text-shadow-purple">
          <span class="inline-flex mb-6 rounded-full bg-violet-900 bg-opacity-50 px-3 py-1 text-sm font-semibold">
            Error&nbsp;404
          </span>
          <h1 class="text-3xl md:text-4xl lg:text-5xl mb-3">
  
            Well this is embarrassing…
          
</h1>
          <p class="text-lg text-pink-200 mb-6">
            The page you’re looking for isn’t here. Feel free to return to the <a href="/" class="underline underline-offset-1 decoration-white/50 font-medium text-white">home page</a> or browse the <a href="/docs/" class="underline underline-offset-1 decoration-white/50 font-medium text-white">docs</a> to find what you&nbsp;need.
          </p>
        </div>
      </article>
    </main>
